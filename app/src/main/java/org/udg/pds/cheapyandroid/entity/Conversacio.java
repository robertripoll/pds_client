...
public class Conversacio {
    ...
    public Conversacio withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Conversacio withNombreMissatges(Integer nombreMissatges) {
        this.nombreMissatges = nombreMissatges;
        return this;
    }
    ...
    public Conversacio withMissatgesPerLlegir(Boolean missatgesPerLlegir) {
        this.missatgesPerLlegir = missatgesPerLlegir;
        return this;
    }
    ...
    public Conversacio withUltimMissatge(String ultimMissatge) {
        this.ultimMissatge = ultimMissatge;
        return this;
    }
    ...
    public Conversacio withProducte(Producte producte) {
        this.producte = producte;
        return this;
    }
    ...
    public Conversacio withUsuari(User usuari) {
        this.usuari = usuari;
        return this;
    }
    ...
    public Conversacio withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
